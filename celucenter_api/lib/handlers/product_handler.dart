...
Router productRouter() {
  ...
  router.get('/', (Request req) async {
    ...
    final products = await Database.instance.getProducts(
        category: category, query: query, sortBy: sortBy);
  ...
  router.get('/<id>', (Request req, String id) async {
    ...
    if (product == null) return _json({'error': 'Producto no encontrado'}, 404);
...
Router categoryRouter() {
  final router = Router();
  router.get('/', (Request req) async {
    final cats = await Database.instance.getCategories();
